  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: GoogleMap(
        ...
        markers:  _pickedLocation==null ? null && widget.isSelecting : {
          Marker(markerId: MarkerId('m1'), position: _pickedLocation ?? LatLng(widget.initalLocation.latit, widget.initalLocation.long) )
        },
